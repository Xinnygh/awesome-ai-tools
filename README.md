...
- [Velobase Harness](https://github.com/velobase/velobase-harness) - Open-source framework for turning AI prototypes into production-ready AI SaaS, with usage billing, payments, attribution, anti-abuse, deployment, auth, multi-LLM chat, workers, lifecycle email, and admin tools.
